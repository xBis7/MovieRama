...
<body>
<div id="sort">Sort by: <a href="">Likes</a> | <a href="sortByHatesAnonym">Hates</a> | <a href="sortByDateAnonym">Date</a></div>
<br/>
<p>
<c:if test="${!empty likesSortedMovieList}">
<c:forEach items="${likesSortedMovieList}" var="movie">
