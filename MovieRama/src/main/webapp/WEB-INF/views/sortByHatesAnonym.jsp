...
<body>
<div id="sort">Sort by: <a href="sortByLikesAnonym">Likes</a> | <a href="">Hates</a> | <a href="sortByDateAnonym">Date</a></div>
<br/>
<p>
<c:if test="${!empty hatesSortedMovieList}">
<c:forEach items="${hatesSortedMovieList}" var="movie">
